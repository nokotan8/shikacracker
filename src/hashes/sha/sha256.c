...
void sha256_transform(sha256_context *ctx, uint8_t *input) {
...
void sha256_process(sha256_context *ctx, uint8_t *input) {
    ...
    // Unrolled loops because I am really bored
    for (; i < 16; i++, j += 4) {
    ...
    // }
    w[16] = sigma1(w[14]) + w[9] + sigma0(w[1]) + w[2];
    w[17] = sigma1(w[15]) + w[10] + sigma0(w[2]) + w[3];
    w[18] = sigma1(w[16]) + w[11] + sigma0(w[3]) + w[4];
    w[19] = sigma1(w[17]) + w[12] + sigma0(w[4]) + w[5];
    w[20] = sigma1(w[18]) + w[13] + sigma0(w[5]) + w[6];
    w[21] = sigma1(w[19]) + w[14] + sigma0(w[6]) + w[7];
    w[22] = sigma1(w[20]) + w[15] + sigma0(w[7]) + w[8];
    w[23] = sigma1(w[21]) + w[16] + sigma0(w[8]) + w[9];
    w[24] = sigma1(w[22]) + w[17] + sigma0(w[9]) + w[10];
    w[25] = sigma1(w[23]) + w[18] + sigma0(w[10]) + w[11];
    w[26] = sigma1(w[24]) + w[19] + sigma0(w[11]) + w[12];
    w[27] = sigma1(w[25]) + w[20] + sigma0(w[12]) + w[13];
    w[28] = sigma1(w[26]) + w[21] + sigma0(w[13]) + w[14];
    w[29] = sigma1(w[27]) + w[22] + sigma0(w[14]) + w[15];
    w[30] = sigma1(w[28]) + w[23] + sigma0(w[15]) + w[16];
    w[31] = sigma1(w[29]) + w[24] + sigma0(w[16]) + w[17];

    w[32] = sigma1(w[30]) + w[25] + sigma0(w[17]) + w[18];
    w[33] = sigma1(w[31]) + w[26] + sigma0(w[18]) + w[19];
    w[34] = sigma1(w[32]) + w[27] + sigma0(w[19]) + w[20];
    w[35] = sigma1(w[33]) + w[28] + sigma0(w[20]) + w[21];
    w[36] = sigma1(w[34]) + w[29] + sigma0(w[21]) + w[22];
    w[37] = sigma1(w[35]) + w[30] + sigma0(w[22]) + w[23];
    w[38] = sigma1(w[36]) + w[31] + sigma0(w[23]) + w[24];
    w[39] = sigma1(w[37]) + w[32] + sigma0(w[24]) + w[25];
    w[40] = sigma1(w[38]) + w[33] + sigma0(w[25]) + w[26];
    w[41] = sigma1(w[39]) + w[34] + sigma0(w[26]) + w[27];
    w[42] = sigma1(w[40]) + w[35] + sigma0(w[27]) + w[28];
    w[43] = sigma1(w[41]) + w[36] + sigma0(w[28]) + w[29];
    w[44] = sigma1(w[42]) + w[37] + sigma0(w[29]) + w[30];
    w[45] = sigma1(w[43]) + w[38] + sigma0(w[30]) + w[31];
    w[46] = sigma1(w[44]) + w[39] + sigma0(w[31]) + w[32];
    w[47] = sigma1(w[45]) + w[40] + sigma0(w[32]) + w[33];

    w[48] = sigma1(w[46]) + w[41] + sigma0(w[33]) + w[34];
    w[49] = sigma1(w[47]) + w[42] + sigma0(w[34]) + w[35];
    w[50] = sigma1(w[48]) + w[43] + sigma0(w[35]) + w[36];
    w[51] = sigma1(w[49]) + w[44] + sigma0(w[36]) + w[37];
    w[52] = sigma1(w[50]) + w[45] + sigma0(w[37]) + w[38];
    w[53] = sigma1(w[51]) + w[46] + sigma0(w[38]) + w[39];
    w[54] = sigma1(w[52]) + w[47] + sigma0(w[39]) + w[40];
    w[55] = sigma1(w[53]) + w[48] + sigma0(w[40]) + w[41];
    w[56] = sigma1(w[54]) + w[49] + sigma0(w[41]) + w[42];
    w[57] = sigma1(w[55]) + w[50] + sigma0(w[42]) + w[43];
    w[58] = sigma1(w[56]) + w[51] + sigma0(w[43]) + w[44];
    w[59] = sigma1(w[57]) + w[52] + sigma0(w[44]) + w[45];
    w[60] = sigma1(w[58]) + w[53] + sigma0(w[45]) + w[46];
    w[61] = sigma1(w[59]) + w[54] + sigma0(w[46]) + w[47];
    w[62] = sigma1(w[60]) + w[55] + sigma0(w[47]) + w[48];
    w[63] = sigma1(w[61]) + w[56] + sigma0(w[48]) + w[49];
...
void sha256_update(sha256_context *ctx, const uint8_t *input, size_t input_len) {
    ...
    for (size_t i = 0; i < input_len; i++) {
        ...
        if (offset == 64) {
            sha256_transform(ctx, ctx->input);
            offset = 0;
        }
    }
}
...
void sha256_final(sha256_context *ctx, uint8_t *output) {
    ...
    ctx->input[56] = (uint8_t)(ctx->size >> 56);
    ctx->input[57] = (uint8_t)(ctx->size >> 48);
    ctx->input[58] = (uint8_t)(ctx->size >> 40);
    ctx->input[59] = (uint8_t)(ctx->size >> 32);
    ctx->input[60] = (uint8_t)(ctx->size >> 24);
    ctx->input[61] = (uint8_t)(ctx->size >> 16);
    ctx->input[62] = (uint8_t)(ctx->size >> 8);
    ctx->input[63] = (uint8_t)(ctx->size);
